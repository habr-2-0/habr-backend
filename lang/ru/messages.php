...
return [
    ...
    'user_image_uploaded' => 'Изображение профиля пользователя успешно загружено.',

    'user_type' => 'User ID должен быть целым числом.',
    'user_post_type' => 'User ID и Post ID должны быть целыми числами.',
